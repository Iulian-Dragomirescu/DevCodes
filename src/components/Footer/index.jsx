...
import hex from "../../assets/images/HexGrid.png";
...
function Footer() {
  ...
  return (
    <footer
      ...
      style={{ backgroundImage: `url(${hex})` }}
    >
      <div class="md:flex md:justify-between">
        <div class="mb-6 md:mb-0">
          <a href="https://devcodes.ro/" class="flex items-center">
            <img src={img()} class="mr-3 w-36" alt="FlowBite Logo" />
        ...
        <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
          <div>
            ...
            <ul class="text-gray-600 dark:text-gray-400">
              <li class="mb-4">
                <a href="#serviciile-noastre" class="hover:underline">
                  Serviciile noastre
                </a>
              </li>
              <li>
                <a href="#cum-te-putem-ajuta-noi" class="hover:underline">
          ...
          <div>
            ...
            <ul class="text-gray-600 dark:text-gray-400">
              <li class="mb-4">
                <button
                  type="button"
                  onClick={() => gaEventTracker({ category: "Telefon Footer" })}
                >
                  <a
                    href="tel:0765865718"
              ...
              <li>
                <button
                  type="button"
                  onClick={() => gaEventTracker({ category: "Email Footer" })}
                >
                  <a
      ...
      <div class="sm:flex sm:items-center sm:justify-between">
        <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">
          ...
          <a href="https://devcodes.ro/" class="hover:underline">
            DevCodes
          </a>
          . All Rights Reserved.
        </span>
